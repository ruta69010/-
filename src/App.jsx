      ...
      <div style={{display:"flex",flexDirection:"column",gap:2,alignItems:"flex-end"}}>
        {isMaiden
          ...
          : <div style={{display:"flex",gap:4,fontSize:9}}>
              <span><span style={{color:"#e2e8f0"}}>近:</span><span style={{color:scoreColor(horse.recentIdx)}}>{horse.recentIdx??"-"}</span>{horse.recentIdxMax!=null&&<span style={{color:"#fff"}}>(最<span style={{color:scoreColor(horse.recentIdxMax)}}>{horse.recentIdxMax}</span>)</span>}</span>
